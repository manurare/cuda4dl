...
# Add with multiple blocks with multiple threads each on the GPU
...
kernel_func = mod.get_function("add")
...
kernel_func(a_gpu, b_gpu, c_gpu, N_gpu, block=(threadCount,1,1), grid=(blockCount,1))
